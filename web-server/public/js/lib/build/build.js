...
require.register("pome-protocol/lib/protocol.js", function(exports, require, module){
...
require.register("pomenode-pome-protobuf/lib/client/protobuf.js", function(exports, require, module){
...
require.register("pomenode-pome-jsclient-websocket/lib/pome-client.js", function(exports, require, module){
(function() {
  ...
  var root = window;
  var pome = Object.create(EventEmitter.prototype); // object extend from object
  root.pome = pome;
  var socket = null;
  var reqId = 0;
  var callbacks = {};
  ...
  var initWebSocket = function(url,cb) {
    ...
    var onerror = function(event) {
      pome.emit('io-error', event);
      console.error('socket error: ', event);
    };
    var onclose = function(event){
      pome.emit('close',event);
  ...
  pome.request = function(route, msg, cb) {
  ...
  pome.notify = function(route, msg) {
    msg = msg || {};
  ...
  var sendMessage = function(reqId, route, msg) {
    ...
    var protos = !!pome.data.protos?pome.data.protos.client:{};
    if(!!protos[route]){
    ...
    var compressRoute = 0;
    if(pome.dict && pome.dict[route]){
      route = pome.dict[route];
      compressRoute = 1;
    }
  ...
  var handshake = function(data){
    ...
    if(data.code === RES_OLD_CLIENT) {
      pome.emit('error', 'client version not fullfill');
      return;
    }

    if(data.code !== RES_OK) {
      pome.emit('error', 'handshake fail');
      return;
    }
  ...
  var processMessage = function(pome, msg) {
    if(!msg.id) {
      // server push message
      pome.emit(msg.route, msg.body);
      return;
    }
  ...
  var processMessageBatch = function(pome, msgs) {
    for(var i=0, l=msgs.length; i<l; i++) {
      processMessage(pome, msgs[i]);
    }
  };

  var deCompose = function(msg){
    var protos = !!pome.data.protos?pome.data.protos.server:{};
    var abbrs = pome.data.abbrs;
    var route = msg.route;
  ...
  //Initilize data used in pome client
  var initData = function(data){
    ...
    if(dict){
      ...
      for(var route in dict){
        pome.data.abbrs[dict[route]] = route;
      }
    }
...
require.alias("boot/index.js", "pome-client/deps/boot/index.js");
require.alias("component-emitter/index.js", "boot/deps/emitter/index.js");
require.alias("component-indexof/index.js", "component-emitter/deps/indexof/index.js");

require.alias("pome-protocol/lib/protocol.js", "boot/deps/pome-protocol/lib/protocol.js");
require.alias("pome-protocol/lib/protocol.js", "boot/deps/pome-protocol/index.js");
require.alias("pome-protocol/lib/protocol.js", "pome-protocol/index.js");

require.alias("pomenode-pome-protobuf/lib/client/protobuf.js", "boot/deps/pome-protobuf/lib/client/protobuf.js");
require.alias("pomenode-pome-protobuf/lib/client/protobuf.js", "boot/deps/pome-protobuf/index.js");
require.alias("pomenode-pome-protobuf/lib/client/protobuf.js", "pomenode-pome-protobuf/index.js");

require.alias("pomenode-pome-jsclient-websocket/lib/pome-client.js", "boot/deps/pome-jsclient-websocket/lib/pome-client.js");
require.alias("pomenode-pome-jsclient-websocket/lib/pome-client.js", "boot/deps/pome-jsclient-websocket/index.js");
require.alias("pomenode-pome-jsclient-websocket/lib/pome-client.js", "pomenode-pome-jsclient-websocket/index.js");